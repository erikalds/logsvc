...
using logsvc::daemon::DefaultClientHandleFactory;
using logsvc::daemon::ClientHandleFactory;

BOOST_AUTO_TEST_SUITE(testDefaultClientHandleFactory)
...
BOOST_FIXTURE_TEST_CASE(is_a_ClientHandleFactory, F)
{
  DefaultClientHandleFactory factory;
  BOOST_CHECK(dynamic_cast<ClientHandleFactory*>(&factory) != nullptr);
}

BOOST_FIXTURE_TEST_CASE(generates_unique_handles, F)
{
  DefaultClientHandleFactory factory;
  BOOST_CHECK(factory.generate_client_handle() != factory.generate_client_handle());
}
